...
if __name__ == "__main__":
    main()# sense el salt de mida (~10.000 punts) que suposaria 2.5km arreu.
...
ZONE_NAMES_CACHE_PATH = "../data/zone_names_cache.json"
ZONE_NAMES_BATCH_PER_RUN = 60  # es manté en 60/execució (~15min per execució, límit dur de Nominatim 4 peticions/min) — amb la graella adaptativa (~6200 punts) tardarà més dies en completar-se del tot (~26 dies en comptes dels ~4-5 originals), però pujar el lot faria aquesta fase sola massa llarga per execució
